...
export const AboutVision = () => {
  return (
    <section id="about" className="py-32 px-6 relative overflow-hidden bg-gradient-to-t from-primary/5 to-transparent border-t border-primary/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        {/* About Section */}
        <div className="space-y-8 animate-in fade-in slide-in-from-left duration-1000">
          <div>
            <div className="font-code text-primary text-xs tracking-[5px] mb-3 opacity-70 uppercase">// IDENTITY_DECRYPTED</div>
          ...
          <div className="space-y-6">
            ...
            <p className="font-body text-lg text-muted-foreground/80 leading-relaxed italic border-l-2 border-primary/30 pl-6">
        ...
        <div className="relative group">
          <div className="absolute -inset-4 bg-primary/5 border border-primary/10 cyber-clip-bl -z-10 group-hover:bg-primary/10 transition-colors duration-500" />
          <div className="p-12 space-y-8 cyber-clip bg-card/40 border border-primary/20 backdrop-blur-sm">
            <div>
              <div className="font-code text-primary text-xs tracking-[5px] mb-3 opacity-70 uppercase">// STRATEGIC_HORIZON</div>
            ...
            <div className="space-y-10">
              <div className="flex gap-6 items-start">
                <div className="w-12 h-12 flex items-center justify-center shrink-0 border border-primary/30 bg-primary/5 font-code text-primary">01</div>
                <div>
              ...
              <div className="flex gap-6 items-start">
                <div className="w-12 h-12 flex items-center justify-center shrink-0 border border-primary/30 bg-primary/5 font-code text-primary">02</div>
                <div>
              ...
              <div className="flex gap-6 items-start">
                <div className="w-12 h-12 flex items-center justify-center shrink-0 border border-primary/30 bg-primary/5 font-code text-primary">03</div>
                <div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 font-code text-[10px] text-primary/20 tracking-[8px] uppercase pointer-events-none">
