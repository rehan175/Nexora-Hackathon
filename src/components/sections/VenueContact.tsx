    ...
    <section id="venue" className="py-32 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-8">
          <div>
            <div className="font-code text-cyan text-xs tracking-[5px] mb-3 opacity-70 uppercase">// COMMAND CENTER</div>
            <h2 className="font-headline font-bold text-4xl text-white mb-6 uppercase">
              Mission <span className="text-cyan">Location</span>
            </h2>
          ...
          <div className="bg-card/60 border border-cyan/10 p-8 cyber-clip hover:border-cyan/30 transition-all group">
            <div className="flex gap-6 items-start">
              <div className="p-4 bg-cyan/10 rounded-lg text-cyan">
                <MapPin size={32} />
              </div>
              <div className="space-y-4">
                ...
                <div className="font-code text-[10px] text-cyan/40 tracking-[2px] uppercase">
          ...
          <div className="aspect-video w-full bg-cyan/5 border border-cyan/10 overflow-hidden cyber-clip-bl opacity-60 grayscale hover:grayscale-0 transition-all duration-700">
            <iframe 
        ...
        <div className="space-y-8">
          <div>
            <div className="font-code text-cyan text-xs tracking-[5px] mb-3 opacity-70 uppercase">// NEURAL LINKS</div>
            <h2 className="font-headline font-bold text-4xl text-white mb-6 uppercase">
              Contact <span className="text-cyan">Squad</span>
            </h2>
            <div className="w-20 h-0.5 bg-cyan relative after:content-[''] after:absolute after:-right-5 after:-top-[3px] after:w-2 after:h-2 after:border-2 after:border-cyan after:rounded-full" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {contacts.map((name, i) => (
              <div 
                key={name} 
                className={`bg-card/40 border border-cyan/10 p-6 cyber-clip transition-all hover:bg-cyan/5 hover:border-cyan/30 ${
                  i === contacts.length - 1 ? 'col-span-2' : ''
                }`}
              >
                <div className="flex items-center gap-4">
                  <div className="w-2 h-2 bg-cyan rounded-full animate-pulse shadow-[0_0_10px_#00d4ff]" />
                  <div>
                    <div className="font-headline text-sm text-white tracking-widest uppercase">{name}</div>
                    <div className="font-code text-[9px] text-cyan/40 tracking-[2px] mt-1">OPERATOR_{i + 1}</div>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="p-8 border border-dashed border-cyan/20 bg-cyan/5 rounded-lg">
